  ...
  return (
    <>
      ...
      <div className="h-[60vh] flex flex-col justify-center items-center bg-[#BA3A2C] text-white">
        <div className="flex flex-col gap-5 items-center text-center">
          <h1 className="text-5xl lg:text-6xl font-semibold">
            Your University&apos;s Marketplace
          </h1>
          <p className="lg:text-[18px] font-medium text-center">
            Buy, sell, rent, and exchange academic resources within your trusted{" "}
      ...
      <div className="flex flex-col justify-center items-center mt-20 gap-8 text-center">
        ...
        <p className="font-medium lg:text-xl text-lg">
          Our platform is specifically designed for university communities with
          features that address your unique needs.
        </p>
      </div>
